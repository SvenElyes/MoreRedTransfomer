...
#SBATCH --output=logs/clean_train_mdtrain-%j.out
...
apptainer run -B /tmp/QM9.sqfs:/input-data:image-src=/ old_container3.sif python -u ../src/scripts/mrdtrain experiment=vp_gauss_ddpm_qm9 run.data_dir="/input-data/energy_U0"
